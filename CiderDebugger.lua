...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "C:/Documents and Settings/joon/Application Data/luaglider2/dev";local SOCKET_PORT=47741;local GLIDER_MAIN_FOLDER= "C:/Documents and Settings/joon/デスクトップ/MyProject/KidsUp_New/kidsup/mobile/android/kidsup";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
