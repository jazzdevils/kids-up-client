                                ...
                                if(rowData.target.read_cnt == rowData.target.total_cnt) then
                                    ...
                                    local options = {
                                        ...
                                        params = {
                                            ...
                                            previous_scene = "scripts.noticeViewFromNewsScene"
                                        }
                                    }
...
--        storyboard.hideOverlay("slideRight", 300)
        ...
        storyboard.gotoScene("scripts.newsScene", "slideRight", 300)
    end
...
--	onRowTouch = nil,--onRowTouch,
    ...
    local function onComment_box_Handler(event)
        if event.phase == "ended" then
            ...
            storyboard.purgeScene("scripts.comment4NewsScene")
            storyboard.gotoScene("scripts.comment4NewsScene", options)
        end
...
--    comment_box.anchorX = 0
    ...
    api.get_news_detail3(paramsData.member_id, paramsData.device_id, paramsData.seq, user.getActiveKid_IDByAuthority(),
...
--    imageGroup = display.newGroup()
    ...
    storyboard.returnTo = "scripts.newsScene"
end
