...
local classId, className, classDesc
...
local function updateClassInfo()
    ...
    api.update_class_info(params, callback)
end

local function onConfirmButton(event)
...
function scene:createScene( event )
    ...
    navBar = widget.newNavigationBar({
        title = language["mngClassUpdateScene"]["title"],
    ...
    classDescField:setText(classDesc)
