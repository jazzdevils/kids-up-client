...
--            centerAddressRefData.classId = row.params.id
--            centerAddressRefData.className = row.params.name
--            centerAddressRefData.classId = classes[idx].id
--            centerAddressRefData.className = classes[idx].name
        end
...
local function okButtonEvent( event )
    if event.phase == "ended" then
        ...
        centerAddressRefData.selectedTeacherClasses = selectedClassList
...
function scene:createScene( event )
    ...
    if ( params.centerAddressRefData ~= nil ) then
        ...
        if centerAddressRefData.selectedTeacherClasses ~= nil then
            selectedClassList = centerAddressRefData.selectedTeacherClasses
        else
            centerAddressRefData.selectedTeacherClasses = selectedClassList
        end
    end
