            ...
            onRelease = function(event)
                            if(event.phase == "ended") then
                                ...
                                for i = 1, rowDataCnt do
                                    if(rowData.member[i].readyn == "0" and rowData.member[i].phonenum ~= "") then
                                ...
                                if(#telNums > 0) then
                                    options = {
                                        to = telNums,
                                        body = "- "..user.userData.centerName.." - "..thread_title.." "..language["notReadListScene"]["message_sms"],
                                    }
        ...
        row.push_button = widget.newButton{
            ...
            onRelease = function(event)
                            if(event.phase == "ended") then
                                ...
                                api.push_not_read_contact_member_list(thread_id, getDataCallBack)
                            end
                        end
        }
...
--        includeStatusBar = true
    ...
    api.get_memberlist_notread_contact(thread_id, getDataCallback)
end
